...
def parse_args():
    ...
    parser.add_argument("--img_path", type=str, default="./test_images/", help="path to images file")
    parser.add_argument("--imgsz", type=int, default=1024, help="images size")
    ...
    parser.add_argument("--output_dir", type=str, default="./", help="images save path")
