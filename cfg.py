...
def parse_args():    
    ...
    parser.add_argument('-weights', type=str, default ="./logs/cluster_attack_0722/Model/checkpoint_best.pth", help='the weights file you want to test')
    ...
    parser.add_argument('-sam_ckpt', default="./logs/cluster_attack_0722/Model/checkpoint_best.pth" , help='sam checkpoint address')
